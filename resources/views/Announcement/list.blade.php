                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex flex-wrap gap-1">
                                            ...
                                            <img src="{{ asset('assets/media/' . $img) }}" class="rounded shadow-sm"
                                                style="width: 50px; height: 50px; object-fit: cover;" alt="Media">
                                            @endforeach
                                            @if(count($media) > 2)
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center me-2"
                                                ...
                                                <small class="text-white fw-bold">{{
                                                    strtoupper(substr($announcement->createdBy, 0, 1)) }}</small>
                                            </div>
                                    ...
                                    <td>
                                        <div class="fw-semibold">{{
                                            \Carbon\Carbon::parse($announcement->eventDate)->format('d M Y') }}</div>
                                        <small class="text-muted">{{
                                            \Carbon\Carbon::parse($announcement->eventDate)->diffForHumans() }}</small>
                                    </td>
                                    <td>
                                        <span
                                            class="badge fs-6 {{ $announcement->status == 'Sent' ? 'bg-success' : ($announcement->status == 'Pending' ? 'bg-warning text-dark' : 'bg-danger') }}">
                                            <i
                                                class="fas {{ $announcement->status == 'Sent' ? 'fa-check' : ($announcement->status == 'Pending' ? 'fa-clock' : 'fa-times') }} me-1"></i>
