...
<head>
    ...
    @if (Request::segment(2) === 'project' or
            Request::segment(2) === 'ecommerce' or
            Request::segment(2) === 'typography' or
            Request::segment(2) === 'progress-bars' or
            Request::segment(2) === 'data' or
            Request::segment(1) === 'file-manager' && Request::segment(2) === 'dashboard' or
            Request::segment(2) === 'teams-board')
        <link rel="stylesheet"
            href="{{ asset('assets/vendor/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css') }}">
    @endif
    ...
    @if (Request::segment(2) === 'contact-list' or
            Request::segment(2) === 'contact-card' or
            Request::segment(2) === 'inbox' or
            Request::segment(2) === 'taskboard' or
            Request::segment(2) === 'dialogs')
    ...
    @if (Request::segment(2) === 'jquery-datatable' ||
            Request::segment(2) === 'superadmin_settings' ||
            Request::segment(2) === 'center_settings' ||
            Request::segment(2) === 'staff_settings' ||
            Request::segment(2) === 'parent_settings' ||
            Request::segment(1) === 'qip')
        <link rel="stylesheet" href="{{ asset('assets/vendor/jquery-datatable/dataTables.bootstrap4.min.css') }}" />
        <link rel="stylesheet"
    ...
    @if (Request::segment(2) === 'list' or
            Request::segment(2) === 'detail' or
            Request::segment(2) === 'blog' or
...
<body class="{{ $theme }}">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img src="{{ url('/') }}/assets/img/MYDIAREE-new-logo.png" width="200px"
                    height="50px" alt="Lucid"></div>
            <p>Please wait...</p>
        </div>
    </div>
    ...
    @if (Request::segment(2) === 'inbox' or
            Request::segment(2) === 'contact-list' or
            Request::segment(2) === 'taskboard' or
            Request::segment(2) === 'dialogs')
