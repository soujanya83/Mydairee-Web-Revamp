...
<div class="row clearfix">
        ...
        <div class="card">
            <div class="body">
                <ul class="nav nav-tabs">                                
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Settings">Profile Settings</a></li>
                </ul>
            </div>
    ...
    <img id="profileImage"
         ...
         class="user-photo media-object profile-img"
         alt="User"
        ...
        <div class="media-body">
            ...
            <button type="button" class="btn btn-default-dark" id="btn-upload-photo" style="border:1px solid lightblue;">Upload Photo</button>
    ...
    <div class="row clearfix">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="form-group">
                ...
                <input type="tel" class="form-control" name="contactNo" value="{{ $user->contactNo }}" required>
            </div>
            <div class="form-group">
                <label>Gender</label>
