    ...
    <div class="container">
        ...
        <div class="info-block">
            ...
            <span class="info-text">
                ...
                @if($childrens && $childrens->isNotEmpty())
               {{ $childrens->map(fn($c) => $c->name . ' ' . $c->lastname)->implode(', ') }}
        ...
        <div class="info-block">
            <strong>Date:</strong>
            <span class="info-text">
                {{ \Carbon\Carbon::parse($snapshots->created_at)->format('d/m/Y') }}
            </span>
        </div>
        ...
        <div class="info-block">
            ...
            <span class="info-text">
                {!! $snapshots->about ?? 'Not updated' !!}
            </span>
        </div>

        <div class="info-block"> <strong>snapshot's Photos:</strong>
            <div class="photo-gallery"> @foreach(($snapshots->mediaUrl ?? []) as $mediaItem)
