...
&nbsp;&nbsp;&nbsp; -->
    <button type="button" class="btn btn-outline-info" onclick="window.location.href='{{ route('snapshot.addnew') }}'">
...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12">
            <h1 class="text-center text-white mb-5 font-weight-bold" style="backdrop-filter:blur(10px);background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);
