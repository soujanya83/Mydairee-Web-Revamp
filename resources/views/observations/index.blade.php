    ...
    <div class="col-lg-6 col-md-3">
        ...
        <a class="d-block position-relative" href="{{ route('observation.print', $obsId) }}" target="_blank">
            @endif
                        ...
                        <!-- Image Part -->
@if(empty($observation->observationsMedia))
...
@else
    @if($observation->observationsMediaType == 'Image')
        @if(file_exists(public_path('api/assets/media/'.$observation->observationsMedia)))
            <img src="{{ asset('api/assets/media/'.$observation->observationsMedia) }}" 
                 alt="Image" 
                 class="list-thumbnail border-0" 
                 style="width:100px;height:100px;object-fit:cover;">
        @else
            <img src="https://via.placeholder.com/320x240?text=Media+Deleted" 
                 ...
                 style="width:100px;height:100px;object-fit:cover;">
        @endif
    @elseif($observation->observationsMediaType == 'Video')
        <img src="{{ asset('api/assets/media/video-thumb.jpg') }}" 
             alt="Video" 
             class="list-thumbnail border-0" 
             style="width:100px;height:100px;object-fit:cover;">
    @endif
