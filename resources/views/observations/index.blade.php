...
<div class="text-zero top-right-button-container d-flex justify-content-end"
    ...
    &nbsp;&nbsp;&nbsp;
    @if(!empty($permissions['addObservation']) && $permissions['addObservation'])
    <button type="button" class="btn btn-outline-info"
        onclick="window.location.href='{{ route('observation.addnew') }}'">Add New</button>
    @endif
    @endif &nbsp;&nbsp;&nbsp;
    ...
    <div class="col-lg-6 col-md-3">
        <div class="d-flex flex-row mb-3 bg-white br-10 align-items-center justify-content-between p-3 card">
            ...
            <div class="d-flex flex-column align-items-center icon-actions">
                ...
                @if(!empty($permissions['deleteObservation']) && $permissions['deleteObservation'])
