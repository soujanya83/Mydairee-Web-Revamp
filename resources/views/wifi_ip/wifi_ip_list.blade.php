                    ...
                    <tbody>
                        ...
                        <tr class="{{ $ingredient->colorClass ?? 'xl-default' }}">
                            ...
                            <td>
                                ...
                                <!-- Delete Button --> &nbsp;
                                <form action="{{ route('settings.WifiIp.destroy', $wifi->id) }}" method="POST" style="display:inline-block;" class="delete-wifi-form">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="btn btn-sm btn-danger delete-wifi-btn" title="Record Delete">
                            ...
                            <script>
                                $(document).ready(function () {
                                    ...
                                    // SweetAlert2 for delete wifi IP
                                    $('.delete-wifi-btn').on('click', function (e) {
                                        e.preventDefault();
                                        const form = $(this).closest('form');
                                        Swal.fire({
                                            title: 'Are you sure?',
                                            text: "This IP will be permanently deleted!",
                                            icon: 'warning',
